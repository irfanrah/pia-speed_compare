...
import numpy as np
import torch
from pia.ai.base import PiaConfigBase, PiaModelBase, PiaONNXConfigBase
...
class T2VRetModelBase(PiaModelBase):
    ...
    def export2onnx(self, onnx_config: T2VRetONNXConfig, model):
        from pia.ai.model import PiaONNXTensorRTModel  # partial import error
