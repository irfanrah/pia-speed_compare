...
WORKINGHIGH_QUEUE_SIZE = int(os.getenv("WORKINGHIGH_QUEUE_SIZE", 25))
WORKINGHIGH_ALARM_DURATION = int(os.getenv("WORKINGHIGH_ALARM_DURATION", 5))
WORKINGHIGH_CV_CATEGORY = ["workinghigh_cv", "고소작업_cv"]
