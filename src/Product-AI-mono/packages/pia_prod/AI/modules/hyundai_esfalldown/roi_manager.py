...
from pia_prod.AI.modules.hyundai_esfalldown.config import ALL_CATEGORIES
import numpy as np
import torch
...
from pia_prod.AI.modules.perception_encoder.config import DEVICE


class ESFalldownRoIManager(ROIManagerBase):
    """
