...
_PROMPT_MAP = {
    "fire_qwen_vqa": FIRE_PROMPT,
    "화재_qwen_vqa": FIRE_PROMPT,
    "smoke_qwen_vqa": SMOKE_PROMPT,
    "연기_qwen_vqa": SMOKE_PROMPT,
    "falldown_qwen_vqa": FALLDOWN_PROMPT,
    "쓰러짐_qwen_vqa": FALLDOWN_PROMPT,
    "smoking_qwen_vqa": SMOKING_PROMPT,
    "흡연_qwen_vqa": SMOKING_PROMPT,
}


def get_prompt(category_name: str) -> str:
    return _PROMPT_MAP.get(category_name)
