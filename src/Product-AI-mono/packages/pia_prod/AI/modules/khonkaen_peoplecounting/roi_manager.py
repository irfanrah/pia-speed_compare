...
import torch
from pia_prod.AI.modules.khonkaen_peoplecounting.config import DEVICE


class PeoplecountingRoIManager(ROIManagerBase):
    """
    ...
    def __init__(self):
        ...
        self.category_list = ["peoplecounting_cv", "피플카운팅_cv"]
