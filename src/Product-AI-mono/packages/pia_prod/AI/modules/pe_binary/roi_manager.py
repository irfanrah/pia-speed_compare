...
import torch
from pia_prod.AI.modules.pe_binary.config import DEVICE, ALL_CATEGORIES
...
class PERoIManager(ROIManagerBase):
    ...
    def __init__(self):
        ...
        self.roi_category_list = ALL_CATEGORIES  # 최종적으로 업데이트된 카테고리에 대해 RoI 를 모든 PE 카테고리에 적용한다.
