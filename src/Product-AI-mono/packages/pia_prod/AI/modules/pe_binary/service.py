...
from pia_prod.AI.modules.pe_binary.event import PEBinaryEventManager
from pia_prod.AI.modules.pe_binary.roi_manager import PERoIManager
from pia_prod.AI.modules.pe_binary.prompts import load_text_feature  # PROMPTS
...
class PEBinaryService(ServiceBase):
    ...
    def _load_model(self):
        self.model = TRTInference(PE_BINARY_TRT_PATH)
    ...
    def _get_txt_vector_group_by_category(self):
        ID_list, class_list, prompt_list, text_features = load_text_feature(
            PE_BINARY_TXT_FEATURE_PATH, DEVICE
        )
