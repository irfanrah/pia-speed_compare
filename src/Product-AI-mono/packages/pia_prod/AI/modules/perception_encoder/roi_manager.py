...
import torch
from pia_prod.AI.modules.perception_encoder.config import DEVICE, ALL_CATEGORIES, FALLDOWN_CATEGORY


class PERoIManager(ROIManagerBase):
    """
    ...
    def __init__(self):
        ...
        self.roi_category_list = FALLDOWN_CATEGORY  # 쓰러짐의 경우에만 ROI를 적용한다 NOTE: 하드코딩이므로 나중에 고쳐야함
