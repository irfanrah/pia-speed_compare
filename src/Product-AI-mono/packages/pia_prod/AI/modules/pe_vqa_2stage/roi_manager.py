...
from pia_prod.AI.modules.pe_vqa_2stage.config import DEVICE, ALL_CATEGORIES, FALLDOWN_CATEGORY


class PeVqa2StageRoIManager(ROIManagerBase):
    """
    PE_VQA_2stage용 RoI 관리 클래스.
    PE의 PERoIManager와 동일한 로직. 쓰러짐 카테고리에만 ROI를 적용한다.
    """
    ...
    def __init__(self):
        ...
        self.roi_category_list = FALLDOWN_CATEGORY
