...
from pia_prod.AI.modules.aramco_loitering.service import LoiteringService
...
def test_aramco_loitering(model_download, local_video_path, get_AddStreamModel):
...
def test_aramco_loitering_batches(
...
def test_import_module():
    ...
    from pia_prod.AI import LoiteringService

    assert LoiteringService is not None, "LoiteringService module import failed"
