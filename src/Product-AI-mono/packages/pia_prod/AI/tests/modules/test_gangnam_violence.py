from pia_prod.AI.modules.gangnam_violence.service import InternVL3TrtViolenceService
from pia_prod.AI.modules.gangnam_violence.config import INTERNVL3_MODEL_HF_PATH
...
def setup_model_and_video(hf_downloader, nas_downloader, video_save_dir):
    ...
    hf_downloader.download(
        repo_id="PIA-SPACE-LAB/InternVL3-2B_gangnam",
        snapshot=True,
    )

    video_name = "elevator_violence_054.mp4"
...
def test_gangnam_internvl3(setup_model_and_video):
...
def test_import_module():
    ...
    from pia_prod.AI import InternVL3TrtViolenceService

    assert InternVL3TrtViolenceService is not None, "InternVL3TrtViolenceService import failed"
