...
import pandas as pd
from overriding_service.weapon_service import ProfileWeaponService
...
def test_weapon_batches(get_video=None, max_batch_size=None):
    q = Queue(100)

    service = ProfileWeaponService(q)
...
if __name__ == "__main__":
    OD_TIME_INTERVAL_SECOND = 1
    VIDEO_PATH = "/home/gpuadmin/repo/forked/KTT_Yonsei-Common-AI-python_fastAPI/Product-AI-mono/assets/videos/10-4-12-250-c1.mp4"
    MAX_BATCH_SIZE = 2
    test_weapon_batches(get_video=VIDEO_PATH, max_batch_size=MAX_BATCH_SIZE)
