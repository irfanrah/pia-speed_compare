...
import pandas as pd
from overriding_service.helmet_service import ProfileHelmetService
...
def test_helmet_batches(get_video=None, max_batch_size=None):
    q = Queue(100)

    service = ProfileHelmetService(q)
...
if __name__ == "__main__":
    ...
    VIDEO_PATH = "/home/gpuadmin/repo/forked/KTT_Yonsei-Common-AI-python_fastAPI/Product-AI-mono/assets/videos/kk_helmet_1.mp4"
    MAX_BATCH_SIZE = 2
    test_helmet_batches(get_video=VIDEO_PATH, max_batch_size=MAX_BATCH_SIZE)
